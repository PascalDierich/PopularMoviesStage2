...
public class ReviewAdapter extends RecyclerView.Adapter<Review> {
	...
	private ArrayList<Review> mResults = new ArrayList<Review>();

	public ReviewAdapter(Context context, int layoutResourceId, ArrayList<Review> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.sTextView = (TextView) convertView.findViewById(R.id.text_view_review_layout);
		...
		holder.sTextView.setText(mResults.get(position).getContent());
