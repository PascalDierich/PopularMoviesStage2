...
public class DownloadTopRatedMoviesInteractor extends AbstractInteractor implements DownloadMovies {

    private DownloadMovies.Callback mCallback;
    private MoviesRepository mRepository;


    public DownloadTopRatedMoviesInteractor(Executor threadExecutor, MainThread mainThread,
    ...
    @Override
    public void run() {
        mRepository.downloadTopRatedMovies();
